...
public class OptionPanes {
	...
	public static ArrayList<String> showCustomInput(String oben, String mitte, ArrayList<String> labels,
			ArrayList<String> fields, int rows, int lines) {
	...
	public static String[] showInput(String oben, String mitte, String feld1, String feld2, String feld3) {
		// Create the custom dialog.
	...
	public static <T> T showButtonSelection(String oben, String mitte, ArrayList<String> namen, ArrayList<T> objekte) {
		// Create the custom dialog.
		...
		for (int i = 0; i < objekte.size(); i++) {
			...
			buttons[i].setOnAction(e -> {
				...
				try {
					...
					Platform.runLater(() -> {
						OptionPanes.showConfirm("Nicht gefunden", "Ich konnte diese Folge leider nicht finden...",
